...
<img src="../_static/media/15.Large_AI_Model_Course/section_1.4/media/image13.png" class="common_img" />
...
Before proceeding, refer to the course "[**19.1.2 Large Speech Model Courses -> Large Language Models Deployment**](#anchor_14_2_1_2)" to obtain your API key, and make sure to add it into the configuration file (config).
...
(3) On the Raspberry Pi desktop, double-click <img src="../_static/media/15.Large_AI_Model_Course/section_3.4/media/image2.png"  /> to open the command-line terminal and enter the ROS2 development environment.
...
(2) Double-click <img src="../_static/media/15.Large_AI_Model_Course/section_4.2/media/image3.png"  /> to launch the command bar. Enter the command and press Enter to disable the auto-start service.
...
(2) Click <img src="../_static/media/15.Large_AI_Model_Course/section_4.2/media/image37.png"  /> in the top-left corner to open the terminal.
...
① Click <img src="../_static/media/15.Large_AI_Model_Course/section_4.3/media/image2.png"  /> in the top-left corner to open the terminal.
