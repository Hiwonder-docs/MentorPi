...
(2) Open the file **"PACK_UPDATE_TOOL.exe"** located in [`20.1 Voice Module Overview and Installation->05 Appendix->Firmware Flashing Tool`](). Select the **"CI1302"** chip and click **"Firmware Upgrade"**.
...
<img src="../_static/media/15.Large_AI_Model_Course/section_1.3/image6.png" class="common_img" />
...
<img src="../_static/media/15.Large_AI_Model_Course/section_1.4/media/image3.png" class="common_img" />
...
<img src="../_static/media/15.Large_AI_Model_Course/section_1.4/media/image8.png" class="common_img" /><img src="../_static/media/15.Large_AI_Model_Course/section_1.4/media/image9.png" class="common_img" />
...
<img src="../_static/media/15.Large_AI_Model_Course/section_1.4/media/image11.png" class="common_img" /><img src="../_static/media/15.Large_AI_Model_Course/section_1.4/media/image12.png" class="common_img" /><img src="../_static/media/15.Large_AI_Model_Course/section_1.4/media/image13.png" class="common_img" />
...
To proceed with this section, you will need to register on the appropriate website and obtain the API key for the large model (please refer to the file ["14.2.1 Large Language Model Courses -> Large Language Model Deployment"](#anchor_19_1_1_2)).
...
③ Once the file is open, configure the OpenAI and OpenRouter keys by filling in the llm_api_key and vllm_api_key parameters, respectively (you can obtain these keys from the '[14.2.1 Large Language Model Courses -> Large Language Model Deployment](#anchor_19_1_1_2)' course).
...
Before starting this section, make sure you have completed the API key configuration outlined in the file [14.2.1 Large Language Model Courses -\> Large Language Model Accessing](#anchor_19_1_1_3).
...
To proceed with this section, ensure that you have completed the API key configuration as described in the file [14.2.1 Language Model Courses -> Large Language Model Accessing](#anchor_19_1_1_3).
...
Refer to the course "[14.2 Large Models Basic Courses ->14.2.1 Large Language Models Courses -> Large Language Models Deployment](#anchor_19_1_1_2)" to obtain your API key, and update the configuration file accordingly.
...
* This section requires the configuration of the API key in "[14.2.3 Vision Language Model Accessing -> Vision Language Model Accessing](#anchor_19_1_1_3)" before proceeding. Additionally, ensure that the images to be used in this section are imported.
...
* This section requires the configuration of the API key in "[**14.2.3 Vision Language Module Courses -> Vision Language Model Accessing**](#anchor_19_1_1_3)" before proceeding. Additionally, ensure that the images to be used in this section are imported.
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.1\media\image3.png"  />
...
The configuration file of this program is saved in: [/home/ubuntu/ros2_ws/src/large_models/large_models/large_models/config.py]()
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.1\media\image13.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.1\media\image15.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.1\media\image16.png"  /><img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.1\media\image17.png"  />
...
By default, the wake-up word for the WonderEcho Pro factory firmware is "Hello, Hiwonder." If you wish to change the wake-up word to **"MentorPi,"** please refer to the tutorial titled "[14.1 Voice Module Overview and Installation-> 14.1.3 Firmware Flashing Method]()" for step-by-step instructions.
...
The robot must be connected to the internet, either in STA (local network) mode or AP (direct connection) mode via Ethernet. For detailed instructions on network configuration, please refer to the course [13. Network Configuration Courses->13.1 Network Configuration Instructions]().
...
(1) Start the robot and follow the instructions in [2. Remote Tool Installation Connection → 2.4 Docker Introduction & Usage]() to connect via the VNC remote desktop software. Then, switch to the ROS2 environment and select the appropriate language version as needed.

(2) On the Raspberry Pi desktop, double-click <img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.2\media\image2.png"  /> to open the command-line terminal and enter the ROS2 development environment.
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.2\media\image10.png"  />
...
The launch file is saved in: [/home/ubuntu/ros2_ws/src/large_models/launch/llm_control_move.launch.py]()
...
The source code is located at: [/home/ubuntu/ros2_ws/src/large_models/large_models/llm_control_move.py]()
...
By default, the wake-up word for the WonderEcho Pro factory firmware is "Hello, Hiwonder." If you wish to change the wake-up word to "MentorPi," please refer to the tutorial titled "03 Firmware Flashing Method" for step-by-step instructions.
...
(1) Start the robot and follow the instructions in [2. Set Development Environment → 2.4 Docker Introduction & Usage]()” to connect via the VNC remote desktop software. Then, switch to the ROS2 environment and select the appropriate language version as needed.

(2) On the Raspberry Pi desktop, double-click <img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.3\media\image2.png"  /> to open the command-line terminal and enter the ROS2 development environment.
...
* **Brief Program Analysis**
  ...
  The launch file is saved in: [/home/ubuntu/ros2_ws/src/large_models/launch/llm_visual_patrol.launch.py]()
...
* **Main Control Program Analysis**
  ...
  The source code is located at: [/home/ubuntu/ros2_ws/src/large_models/large_models/llm_visual_patrol.py]()
...
The configuration file of this program is saved in: [/home/ubuntu/ros2_ws/src/app/app/line_following.py]()
...
By default, the program does not include the configuration of the Large AI Model-related API keys. Before activating features related to the Large AI Model, please refer to the section [14.3 Multimodal Large Model Applications -\> 14.3.1 Obtaining and Configuring Large Model API Keys]() to configure the necessary keys. This step is mandatory and cannot be skipped, as it is crucial for the proper functioning and experience of the large model features.
...
(1) Start the robot and follow the instructions in [2.Remote Tool Installation Connection → 2.4 Docker Container Introduction and Entry]() to connect via the VNC remote desktop software. Then, switch to the ROS2 environment and select the appropriate language version as needed.

(2) Power on the robot and remotely connect to the Raspberry Pi desktop via VNC.

(3) On the Raspberry Pi desktop, double-click <img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.4\media\image2.png"  /> to open the command-line terminal and enter the ROS2 development environment.
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.4\media\image5.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.4\media\image6.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.4\media\image7.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.4\media\image8.png"   />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_3.4\media\image9.png"  />
...
The source code is located at: [/home/ubuntu/ros2_ws/src/large_models/large_models/llm_color_track.py]()
...
The configuration file of this program is saved in: [/home/ubuntu/ros2_ws/src/app/app/object_tracking.py]()
...
(1) Click <img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.1\media\image2.png"  /> in the top-left corner to open the terminal.
...
(1) Start the robot and follow the instructions in [2. Set Development Enviroment → 2.4 Docker Introduction & Usage]() to connect via the VNC remote desktop software. Then, switch to the ROS2 environment and select the appropriate language version as needed.
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.1\media\image6.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.1\media\image7.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.1\media\image8.png"  />

(9) When the command line shows the output below, it indicates that the cloud-based large speech model’s speech recognition service has successfully processed the user’s command audio. The recognition result will be displayed under “publish_asr_result.”

<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.1\media\image9.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.1\media\image10.png"  />

(12) To exit this feature, simply press **“Ctrl+C”** in the terminal. If it doesn’t close on the first attempt, you may need to press it multiple times.

<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.1\media\image11.png"  />
...
The program is saved at:[/home/ubuntu/ros2_ws/src/large_models/launch/vllm_with_camera.launch.py]()
...
The source code is located at:[/home/ubuntu/ros2_ws/src/large_models/large_models/vllm_with_camera.py]()
...
Refer to [6. Mapping Lesson -\>6.5 slam_toolbox Mapping Algorithm]() to pre-build and save the map in advance.
...
(1) Start the robot and follow the instructions in [2. Set Development → 2.4 Docker Introduction & Usage]() to connect via the VNC remote desktop software. Then, switch to the ROS2 environment and select the appropriate language version as needed.

(2) Double-click <img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.2\media\image3.png"  /> to launch the command bar. Enter the command and press Enter to disable the auto-start service.
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.2\media\image6.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.2\media\image7.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.2\media\image8.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.2\media\image9.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.2\media\image10.png"  />
...
To update the navigation waypoints in the program, edit the following file:[ros2_ws/src/large_models/large_models/vllm_navigation.py]()

(1) First, refer to [Starting and Stopping the Game->Step (4)]() to launch the program and open the RViz map visualization. Use the 2D Goal Pose tool to set the desired navigation target directly on the map.

<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.2\media\image13.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.2\media\image14.png"  />

<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.2\media\image15.png"  />
...
The program is saved at:[/home/ubuntu/ros2_ws/src/large_models/large_models/vllm_navigation.py]()
...
If the game is lagging or performing poorly, you can display RVIZ on the virtual machine as follows. Refer to the instructions in [6. Mapping Lesson->6.5 slam_toolbox Mapping Algorithm->6.5.2 Mapping Operation Steps]() for placing the necessary files in the virtual machine under:
...
(2) Click <img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.2\media\image37.png"  /> in the top-left corner to open the terminal.
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course/section_4.2/media/image39.png"  />
...
By default, the wake-up word for the WonderEcho Pro factory firmware is **"Hello, Hiwonder."** If you wish to change the wake-up word to **"MentorPi,"** please refer to the tutorial titled [14.1.3 Firmware Flashing Method]() for step-by-step instructions.
...
① Click <img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.3\media\image2.png"  /> in the top-left corner to open the terminal.
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.3\media\image6.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.3\media\image7.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.3\media\image8.png"  />

(8) You can freely phrase your commands to control the movement of MentorPi, such as saying, "**Track the purple ball**."

<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.3\media\image9.png"  />

(9) When the command line displays the output shown below, it indicates that MentorPi has printed the recognized speech.

<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.3\media\image10.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.3\media\image11.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.3\media\image12.png"  />
...
<img class="common_img" src="../_static/media/15.Large_AI_Model_Course\section_4.3\media\image13.png"  />
...
The program is saved at:[/home/ubuntu/ros2_ws/src/large_models/launch/vllm_track.launch.py]()
...
The source code is located at:[/home/ubuntu/ros2_ws/src/large_models/large_models/vllm_track.py]()
