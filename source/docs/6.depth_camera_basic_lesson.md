# 6. Depth Camera Basic Lesson

## 1. Test and Configure ROS2

:::{Note}

* Before starting this course, please refer to "[Linux Basic Lesson\3.Linux Installation and Source Replacement]()" to install the virtual machine client and import the ROS2 Ubuntu image.

* The image file we provide is in the "Appendix->Virtual Machine Image->Hiwonder_ROS_accessory_ros2", and the ROS2 environment is already configured. You can refer to this section for a brief overview of the ROS2 system installation and environment setup.
...
### 1.2 Check Ubuntu's Software and Update Sources
...
<img  class="common_img"  src="../_static/media/6.Depth_Camera_Basic_Lesson/6.1/media/image7.jpeg"    />

### 1.4 Set the Download Source for ROS2

**1.4.1 Enable the Ubuntu Universe Repository**
...
<img  class="common_img"  src="../_static/media/6.Depth_Camera_Basic_Lesson/6.1/media/image8.jpeg"    />
...
**1.4.2 Update the software packages and install the curl and gnupg tools**
...
### 1.6 Install Additional Dependency
...
### 2.1 Depth Camera Configuration
...
(1) Open virtual machine <img  class="common_img"  src="../_static/media/6.Depth_Camera_Basic_Lesson/6.2/media/image2.png"   />.
...
(5) Click on <img  class="common_img"  src="../_static/media/6.Depth_Camera_Basic_Lesson/6.2/media/image7.png"   /> to open terminal. Or press the short-cut "Ctrl+Alt+t" to open the command-line terminal.
...
Before starting, make sure to follow the instructions in the "[2.Depth Camera Configuration](#anchor_2)" in the same directory to set up the operating environment.
...
<img  class="common_img"  src="../_static/media/6.Depth_Camera_Basic_Lesson/6.3/media/image4.png"   />
...
<img  class="common_img"  src="../_static/media/6.Depth_Camera_Basic_Lesson/6.3/media/image5.png"   />
...
<img  class="common_img"  src="../_static/media/6.Depth_Camera_Basic_Lesson/6.3/media/image6.png"   />
...
<img  class="common_img"  src="../_static/media/6.Depth_Camera_Basic_Lesson/6.3/media/image9.png"   />
...
Before starting, make sure that you have followed the "[2. Depth Camera Configuration](#anchor_2)" in the same directory as this lesson to set up the workspace. Ensure that you have successfully compiled the depth camera package based on "Lesson 2 Install Depth Camera ROS2 SDK".
...
<img  class="common_img"  src="../_static/media//6.Depth_Camera_Basic_Lesson/6.4/media/image3.png"   />
...
**4.1.1 View Image Using rqt_image_view Tool**
...
<img  class="common_img"  src="../_static/media//6.Depth_Camera_Basic_Lesson/6.4/media/image4.png"   />
...
<img  class="common_img"  src="../_static/media//6.Depth_Camera_Basic_Lesson/6.4/media/image9.png"   />
...
<img  class="common_img"  src="../_static/media//6.Depth_Camera_Basic_Lesson/6.5/media/image6.png"   />
...
## 6. Web Real-time Monitoring

### 6.1 Web Real-time Monitoring
...
### 6.2 Enable Robot Auto-start Service

Robot's Camera Transmission Service:

(1) If the robot has not started up yet, switch it on. Then, you can ahead to "2.1 Access Live Camera Feed Through Web" to view the live camera feed through the browser.
...
④ Then, you can proceed to "2.1 Access Live Camera Feed Through Web" to view the live camera feed through the browser.

**6.2.1 Access Live Camera Feed Through Web**
