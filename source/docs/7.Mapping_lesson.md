...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.1\media\image2.png" style="width:5.3125in;height:3.91181in" />

(2) Click "Next".

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.1\media\image3.png" style="width:5.3125in;height:3.87292in" />

(3) Click "Next".

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.1\media\image4.png" style="width:5.36458in;height:3.89444in" />

(4) Keep the default installation location and click "Install".

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.1\media\image5.png" style="width:5.34375in;height:3.88819in" />

(5) After waiting for a moment, a prompt window will appear indicating that the installation is complete. Click "Finish".

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.1\media\image6.png" style="width:5.33333in;height:3.88194in" />
...
### 2.2 Comparison between Xacro and URDF Models
...
### 2.3 Basic Syntax of URDF Model

**2.3.1 XML Basic Syntax**
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image2.png" style="width:5.51181in;height:1.2309in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image3.png" style="width:5.3125in;height:3.59375in" />

The following tags will be used to write joint motion.

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image4.png" style="width:5.76806in;height:1.52708in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image5.png" style="width:5.76458in;height:1.48542in" />

**2.3.5 gazebo Tag**

This tag is used in conjunction with the Gazebo simulator. Within this tag, you can define simulation parameters and import Gazebo plugins, as well as specify Gazebo's physical properties, and more.

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image6.png" style="width:5.76319in;height:0.66875in" />

**2.3.6 Write Simple URDF Model**

**(1) Name the model of the robot**

To start writing the URDF model, we need to set the name of the robot following this format: “**\<robot name=“robot model name”\>**”. Lastly, input “**\</robot\>**” at the end to represent that the model is written successfully.

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image7.png" style="width:5.76458in;height:0.37917in" />

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image8.png" style="width:5.76597in;height:0.17917in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image9.png" style="width:5.76528in;height:0.17292in" />

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image10.png" style="width:5.76667in;height:0.17639in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image11.png" style="width:5.76389in;height:0.2125in" />

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image12.png" style="width:5.76667in;height:0.2875in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image13.png" style="width:5.76597in;height:0.49583in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image14.png" style="width:5.76736in;height:0.13819in" />

⑤ The "**\<material\>**" tag is used to define the visual appearance of a link, with indentation used to specify the detailed description of the link's color. To start describing the color, include "**\<material\>**", and end with "**\</material\>**" when the description is complete. The following example demonstrates setting a link color to yellow: "**\<color rgba="1 1 0 1" /\>**". In this example, "**rgba="1 1 0 1"**" represents the color threshold for achieving a yellow color.

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image15.png" style="width:5.76389in;height:0.46319in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image16.png" style="width:5.76389in;height:0.15833in" />

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image17.png" style="width:5.7625in;height:0.15069in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image18.png" style="width:5.76458in;height:0.28889in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image19.png" style="width:5.76111in;height:0.17569in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image20.png" style="width:5.76597in;height:0.20347in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image21.png" style="width:5.76042in;height:0.10903in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2\media\image22.png" style="width:5.76181in;height:0.16875in" />

The complete codes are as below.

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.2/media/image23.png" style="width:4.99097in;height:8.95139in" />

## 3.ROS Robot URDF Model Instruction

### 3.1 Getting Ready

To grasp the URDF model, check out "[2.URDF Model Introduction]()" for the key syntax. This part quickly breaks down the robot model code and its components.

### 3.2 Check Code of Robot Model
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.3/media/image7.png" style="width:5.76181in;height:1.31111in" />
...
### 3.3 Brief Analysis of Robot's Main Body Model
...
The above code defines a joint named “wheel_lf_Joint” for the left front wheel. <span class="mark">The type of this joint is “continuous”, indicating that it is a continuously rotating joint used to describe a component that can rotate without limits, such as a wheel.</span>

<span class="mark">The \<origin\> tag specifies the position and orientation of the joint by “xyz="0.067052 0.07591 -0.01”.</span>

<span class="mark">The parent and child links of the joint are specified using the \<parent\> and \<child\> tags, respectively. The parent link is “base_link”, and the child link is “wheel_lf_Link”, indicating that the joint connects the base link and the left front wheel link. The \<axis\> tag is used to define the rotation axis of the joint, with the direction specified by the xyz="0.00012228 1 -4.0642E-05" attribute.</span>

<span class="mark">This code describes a joint in a URDF file that connects the parent link “base_link” to the child link “wheel_lf_Link”. This joint describes the rotational connection of the left front wheel in the robot model, allowing it to rotate infinitely around the specified axis.</span>

## 4.SLAM Mapping Principle

### 4.1 SLAM Introduction
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.4\media\image2.jpeg" style="width:2.44931in;height:2.17847in" alt="C:\Users\Administrator\Pictures\3.jpg3" />
...
## 5.slam_toolbox Mapping Algorithm
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image2.png" style="width:3.15903in;height:3.79931in" alt="图片3" />
...
**5.2.1 Install Virtual Machine Software and Import the Virtual Machine**

(1) Unzip the provided installation files, then click on the installation file to proceed with the installation.

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image3.png" style="width:5.16667in;height:0.23958in" alt="企业微信截图_17161958067120" />

(2) Click on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image4.png" style="width:0.29514in;height:0.34583in" /> to open the virtual machine.

(3) Enter the virtual machine interface and click on "Open Virtual Machine".

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image5.png" style="width:5.12153in;height:1.00069in" />
...
**5.2.2 Copy Robot Files to the Virtual Machine**

**(1) Export files from the robot**

① Start the robot, and access the robot system desktop using VNC.

② Click-on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image6.png" style="width:0.44792in;height:0.35417in" /> to open the ROS2 command-line terminal.
...
⑩ Click-on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image14.png" style="width:0.42014in;height:0.42847in" /> to open the file directory, then navigate to the home/docker/tmp directory:

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image15.png" style="width:5.75556in;height:0.94306in" />

⑪Use the shortcut 'Ctrl + H' to show the hidden .typerc file:

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image16.png" style="width:5.76458in;height:0.72986in" />

⑫ Refer to the instruction in “Install WinSCP” to install and open the WinSCP tool.

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image17.png" style="width:5.76528in;height:3.57292in" />

⑬ Enter the IP address of Raspberry Pi **“192.168.149.1”**, username **“pi”**, and password **“raspberrypi”**. Then click “Login”.

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image18.png" style="width:5.76319in;height:3.88194in" />

 ⑭ Click “Accept” on the pop-up window that appears.

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image19.png" style="width:5.61458in;height:4.375in" />

⑮ The left side shows the directory of your computer, and the right side shows the root directory of Raspberry Pi.

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image20.png" style="width:5.75625in;height:2.56181in" />

⑯Select the folder "docker-\>tmp" and open the shared folder with Docker.

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image21.png" style="width:5.76528in;height:2.35139in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image22.png" style="width:5.75903in;height:3.45347in" />

⑱ Select the "src" folder and right-click to choose "Download".

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image23.png" style="width:5.76389in;height:3.44861in" />

⑲ Select the path where you want to save the file and click "OK".

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image24.png" style="width:5.38542in;height:2.29167in" />

⑳ Follow step ⑱ to save the .typerc file.

**(2) Import files into the virtual machine**

① Click-on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image25.png" style="width:0.43403in;height:0.40208in" /> to navigate to the home directory.

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image26.png" style="width:5.76597in;height:1.52708in" />

② Drag and drop the .typerc and src.zip files from the computer desktop into the virtual machine:

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image27.png" style="width:5.76181in;height:2.70069in" />

**5.2.3 Create and Compile the Workspace**

(1) Click-on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image28.png" style="width:0.41042in;height:0.34514in" /> to start the virtual machine command-line terminal.
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image37.png" style="width:5.7625in;height:0.96597in" />

(10) After finishing writing, use the shortcut **Ctrl + S** or click the **Save** button in the upper right corner to save and exit.

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image38.png" style="width:5.76319in;height:0.33125in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image39.png" style="width:5.76319in;height:1.48056in" />

**5.2.4 Set the Robot to LAN Mode**

(1) Click-on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image40.png" style="width:0.32292in;height:0.29167in" /> to open the command line terminal.
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image42.png" style="width:in;height:in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image43.png" style="width:in;height:in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image45.png" style="width:5.76528in;height:1.42569in" />

(6) Refer to “Getting Ready -\> APP Control” to obtain the robot's LAN IP address through the app connection.

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image46.png" style="width:5.75278in;height:3.14583in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image47.png" style="width:5.75972in;height:2.13889in" />

② Robot:

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image48.png" style="width:5.76528in;height:2.95556in" />

(8) After rebooting, click on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image6.png" style="width:0.44792in;height:0.35417in" /> to open the robot's ROS2 command line terminal. You will notice that the ROS_DOMAIN_ID is 0, which is the same as on the virtual machine.

① Robot:

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image49.png" style="width:5.76806in;height:2.31667in" />

② Virtual Machine:

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image50.png" style="width:5.76042in;height:0.90833in" />

### 5.3 slam Mapping Instructions

**5.3.1 Robot operations**

(1) Click-on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image6.png" style="width:0.44792in;height:0.35417in" /> to open the command-line terminal.
...
**5.3.2 Virtual Machine instructions**

(1) Click-on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image53.png" style="width:0.47917in;height:0.40625in" /> to open the command line terminal of the virtual machine system.
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image55.png" style="width:5.76528in;height:3.26042in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image57.png" style="width:in;height:in" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image58.png" style="width:5.76806in;height:0.51111in" />
...
Click <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image59.png" style="width:0.4375in;height:0.35417in" /> and enter the command. Press enter to start the app, and wait for the buzzer to beep.
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image60.png" style="width:5.76389in;height:0.59236in" />

### 5.5 Effect Optimization
...
### 5.7 Launch File Analysis

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image61.png" style="width:5.75972in;height:2.075in" alt="图片1" />

The launch file is located at:**[/home/ubuntu/ros2_ws/src/slam/launch/slam.launch.py]()**

**5.7.1 Import Library**
...
**5.7.3 Initiate Other Launch File**
...
## **6.RTAB-VSLAM 3D Mapping**

### **6.1** RTAB-VSLAM Description
...
### **6.2** RTAB-VSLAM Working Principle
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.6\media\image2.png" style="width:5.90764in;height:1.37847in" alt="图片1" />

RTAB-VSLAM software package link: <https://github.com/introlab/rtabmap>

### **6.3** RTAB-VSLAM 3D Mapping Instructions

**6.3.1 Robot Operations**
...
**6.3.2 Virtual Machine Operation**
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.6\media\image7.png" style="width:5.76319in;height:0.16667in" />

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.6\media\image8.png" style="width:4.85694in;height:2.58472in" />

**6.3.3 Enable Keyboard Control**
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.6\media\image10.png" style="width:2.85486in;height:2.04653in" />
...
**6.3.5 Launch File Analysis**

<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.6\media\image13.png" style="width:5.76389in;height:0.84861in" alt="图片2" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.6\media\image16.png" style="width:5.76667in;height:3.09097in" />
