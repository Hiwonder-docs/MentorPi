...
For instructions on app connection, please consult the tutorial located in "[1.Getting Ready/ 6. APP Control](https://docs.hiwonder.com/projects/MentorPi/en/latest/docs/1.Getting_Ready.html#app-control)".
...
(1) Start the robot, and access the robot system desktop using VNC according to the tutorial saved in "<a href="https://docs.hiwonder.com/projects/TurboPi/en/latest/docs/1.getting_ready.html#remote-desktop-installation-and-connection" target="_blank">Set Development Environment/1.VNC Installation and Connection</a>".
