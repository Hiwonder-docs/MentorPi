...
<img class="common_img" src="../_static/media/1.getting_ready/1.2/media/image4.png"  style="width:500px"  />

Charging port location diagram for Mecanum wheel chassis

<img class="common_img" src="../_static/media/1.getting_ready/1.2/media/image5.png"  style="width:500px"  />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.3/media/image1.png"   style="width:500px" />

<img class="common_img" src="../_static/media/1.getting_ready/1.3/media/image2.png"  style="width:500px"  />

<img class="common_img" src="../_static/media/1.getting_ready/1.3/media/image3.png"  style="width:500px"  />

<img class="common_img" src="../_static/media/1.getting_ready/1.3/media/image4.png"  style="width:500px" />

<img class="common_img" src="../_static/media/1.getting_ready/1.3/media/image5.png"  style="width:500px" />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.4/media/image2.png"  style="width:500px"  />

<img class="common_img" src="../_static/media/1.getting_ready/1.4/media/image3.png"   style="width:500px" />

<img class="common_img" src="../_static/media/1.getting_ready/1.4/media/image4.png" style="width:500px"  />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image2.jpeg"    />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image3.png"   />

② Click the "+" button at the lower right corner to select direct connection mode.

<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image4.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image5.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image8.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image9.jpeg"    />

⑦ The game mode selection interface is as below:

<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image10.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image12.png"   />

③ Click the "+" button at the lower right corner to select LAN mode.

<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image13.jpeg"    />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image14.png"    />

⑤ Click "Go to connect device hotspots".

<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image15.png"    />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image16.png"   /><img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image17.png"   />

⑦ After the connection is complete, the app will start automatically configuring the network.

<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image18.jpeg"    />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image19.jpeg"    />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image20.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image21.jpeg"    />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image27.png"   />
...
④ Top Menu Bar: Contains icons for capturing screenshots <img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image28.png"   />, toggling the navigation bar <img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image29.png"   />, and switching to fullscreen mode <img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image30.png"   /> (typically used with a wireless handle).
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image32.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image33.jpeg"    />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image38.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image45.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image46.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image47.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image53.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image54.png"   />

<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image55.png"   />
...
<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image58.png"   />

② Move your hand in one of the up, down, left, or right directions for a certain distance while keeping your hand open.

<img class="common_img" src="../_static/media/1.getting_ready/1.6/media/image59.png"   />
