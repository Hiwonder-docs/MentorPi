...
| ------- | :----------------------------------------------------------: | :----------: | ------------------------------------------------------------ |
| 1       |    M1 (Mecanum) Chassis<br/>(Assembled; Battery included)    |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image1.0.png"    /> |
| 2       |                     Controller top cover                     |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image2.png"    /> |
| 3       |                         Front cover                          |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image3.png"    /> |
| 4       |                          Rear cover                          |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image4.png"    /> |
| 5       |                Raspberry Pi 5<br/>(optional)                 |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image5.png"    /> |
| 6       |                     RRC Lite controller                      |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image6.png"    /> |
| 7       |                         Cooling fan                          |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image7.png"    /> |
| 8       |               Raspberry Pi power supply cable                |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image8.png"    /> |
| 9       |                        RRC data cable                        |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image9.png"    /> |
| 10      |                 64GB SD card<br/>(optional)                  |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image10.png"    /> |
| 11      |                         Card reader                          |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image11.png"    /> |
| 12      |                        Battery cable                         |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image12.png"    /> |
| 13      |                            Lidar                             |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image13.png"    /> |
| 14      |                       4PIN Lidar wire                        |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image14.png"    /> |
| 15      |                       Lidar data cable                       |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image15.png"    /> |
| 16      |         8.4V 2A charger (DC5.5 * 2.5 male connector)         |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image16.png"    /> |
| 17      |                       Monocular camera                       |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image17.png"    /> |
| 18      |             Wireless handle and Handle receiver              |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image18.png"    /><img src="../_static/media/1.getting_ready/1.1/media/image18.1.png"    /> |
| 19      |                           EVA ball                           |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image19.png"    /> |
| 20      | Accessory bag<br>(M2.5 * 20 Double-pass nylon column *6<br/>M3 *6 Black round head screw * 14<br/>M2 *6 Round head screw * 4<br/>M2.5 *6 Round head screw * 10<br/>M2.5 * 10+6 Single-pass nylon column * 1) |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image20.png"    /> |
| 21      |                         User manual                          |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image21.png"    /> |
...
| 14      |                       4PIN Lidar wire                        |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image14.png"    /> |
| 15      |                       Lidar data cable                       |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image15.png"    /> |
| 16      |       8.4V 2A charger <br>(DC5.5 * 2.5 male connector)       |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image16.png"    /> |
| 17      |                         Depth camera                         |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image17.1.png"    /> |
| 18      |             Wireless handle and Handle receiver              |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image18.png"    /><img src="../_static/media/1.getting_ready/1.1/media/image18.1.png"    /> |
| 19      |                           EVA ball                           |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image19.png"    /> |
| 20      | Accessory bag<br>(M2.5 * 20 Double-pass nylon column *6<br>M3 *6 Black round head screw * 14<br>M2 *6 Round head screw * 4<br>M2.5 *6 Round head screw * 10<br>M2.5 * 10+6 Single-pass nylon column * 1) |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image20.png"    /> |
| 21      |                         User manual                          |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image21.png"    /> |
...
| **No.** |                          Components                          | **Quantity** | **Picture**                                                  |
| ------- | :----------------------------------------------------------: | :----------: | ------------------------------------------------------------ |
| 1       |   A1 (Ackerman) Chassis<br/>(Assembled; Battery included)    |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image1.1.png"    /> |
| 2       |                     Controller top cover                     |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image2.png"    /> |
| 3       |                         Front cover                          |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image3.png"    /> |
| 4       |                          Rear cover                          |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image4.png"    /> |
| 5       |                Raspberry Pi 5<br/>(optional)                 |      1       | <img src="../_static/media/1.getting_ready/1.1/media/image5.png"    /> |
...
:::{Note}
If you use the LAN mode, please refer to " [**Connection Mode -> (2\) LAN Mode Connection**](#anchor_6_1_2_2)".
:::
...
For specific operation method for each game, please refer to "[**1.7.2 APP Games Introduction**](#anchor_6_2)".
...
⑩ You can search for its IP address on the remote desktop tool and establish a connection. For specific connection method, please access the "[**2. Set Development Environment**]()".  
