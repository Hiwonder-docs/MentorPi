...
Before starting, make sure to follow the instructions in the “[2.Depth Camera Configuration]()” in the same directory to set up the operating environment.
...
Before starting, make sure that you have followed the "Lesson 1 Depth Camera Configuration" in the same directory as this lesson to set up the workspace. Ensure that you have successfully compiled the depth camera package based on "Lesson 2 Install Depth Camera ROS2 SDK".
