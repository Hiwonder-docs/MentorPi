# 4.Motion Control Lesson

## 1.Mecanum Wheel Chassis Motion Analysis

### **1.1** Hardware Structure

<img class="common_img" src="../_static/media/4.MotionControlLesson\4.1\media\image2.png"   />
...
<img class="common_img" src="../_static/media/4.MotionControlLesson\4.1\media\image3.png"   />
...
### **1.3** Motion Principle and Formula
...
## 2.Ackerman Chassis Motion Analysis
...
<img class="common_img" src="../_static/media/4.MotionControlLesson\4.2\media\image3.png"   />
...
## 3.IMU, Linear Velocity and Angular Velocity Calibration
...
<img class="common_img" src="../_static/media/4.MotionControlLesson/4.3/media/image11.png"   />
...
### 3.2 Angular Velocity Calibration
...
### 3.3 Linear Velocity Calibration
...
## 4.Publish IMU and Odometer Data
...
### 4.1 Introduction to IMU and Odometer
...
<img class="common_img" src="../_static/media/4.MotionControlLesson\4.4\media\image5.png"  />
...
<img class="common_img" src="../_static/media/4.MotionControlLesson\4.4\media\image8.png"  />
...
**4.1.2 Odometer Data Publishing**
...
<img class="common_img" src="../_static/media/4.MotionControlLesson\4.4\media\image15.png"  />
...
Click <img class="common_img" src="../_static/media/4.MotionControlLesson\4.4\media\image10.png"  /> and enter the command. Press enter to start the app, and wait for the buzzer to beep.
...
## 5.Mecanum Wheel Chassis Speed Control
...
### 5.2 Disable APP Service and Initiate Speed Control
...
(2) Click-on <img class="common_img" src="../_static/media/4.MotionControlLesson\4.5\media\image3.png"  /> to open the command-line terminal.
...
<img class="common_img" src="../_static/media/4.MotionControlLesson\4.5\media\image6.png"  />
...
<img class="common_img" src="../_static/media/4.MotionControlLesson\4.5\media\image11.png"  />
...
**5.3.2 Python Program**

<img class="common_img" src="../_static/media/4.MotionControlLesson\4.5\media\image18.png"   />

The Python program is saved in: [/home/ubuntu/ros2 ws/src/driver/controller/controller/odom publisher node.py]()
...
<img class="common_img" src="../_static/media/4.MotionControlLesson\4.5\media\image19.png"  />
...
<img class="common_img" src="../_static/media/4.MotionControlLesson\4.5\media\image23.png"  />
...
## **6.Ackerman Chassis Speed Control**
...
### 6.2 Disable APP Service and Initiate Speed Control
...
**6.3.2 Python Program**

<img class="common_img" src="../_static/media/4.MotionControlLesson/4.6/media/image16.png"   />

The Python program is saved in: [/home/ubuntu/ros2_ws/src/driver/controller/controller/odom_publisher.node.py]()
