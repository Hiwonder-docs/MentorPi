...
**Note: to learn about the type of the joint, please refer to "[3.3 Joint](#anchor_2_3_3)".**
...
To grasp the URDF model, check out "[2.URDF Model Introduction](#anchor_2_1)" for the key syntax. This part quickly breaks down the robot model code and its components.
...
(2) Click on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image4.png" /> to open the virtual machine.
...
② Click-on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image6.png" /> to open the ROS2 command-line terminal.
...
⑩ Click-on <img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image14.png"  /> to open the file directory, then navigate to the home/docker/tmp directory:
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image45.png" />

(6) Refer to "Getting Ready -\> APP Control" to obtain the robot's LAN IP address through the app connection.

<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image46.png" />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image58.png"  />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson/7.5/media/image60.png"  />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.6\media\image7.png"  />
...
<img class="common_img" src="../_static/media/7.Mapping_Lesson\7.6\media\image16.png"  />
